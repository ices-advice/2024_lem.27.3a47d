...
##         bootstrap/data/ICESCatchDataset2006_2020.csv
##         bootstrap/data/Prelimcatch2021v2.csv
##         bootstrap/data/Prelimcatch2022v2.csv
##         bootstrap/data/CatchAndSampleDataTables.txt
##         bootstrap/data/lem_lenFreq.csv
##         bootstrap/data/SMALK_lemonsole_nsibts_q1.csv
##         bootstrap/data/SMALK_lemonsole_nsibts_q3.csv
##
## After:  data/Official_country_division.csv
##         data/Official_division.csv
##         data/Official_total.csv
##         data/Prel_division_bms.csv
...
#   read ICES official landings 2006-2020

catch1<-read.csv("bootstrap/data/ICESCatchDataset2006_2020.csv", header=T)
...
#  read Preliminary catch statistics

prel1<-read.csv("bootstrap/data/Prelimcatch2021v2.csv", header=T, sep=",")
prel2<-read.csv("bootstrap/data/Prelimcatch2022v2.csv", header=T, sep=",")
...
prel[is.na(prel$BMS_Catch),"BMS_Catch"]<-0
prel$BMS.Catch<-as.numeric(prel$BMS_Catch)
prel$AMS.Catch<-prel$AMS_Catch

prel[prel$Area%in%c("27_3_A","27_3_A_20","27_3_A_21" ), "Area"]<-"3a"
prel[prel$Area%in%c("27_7_D"), "Area"]<-"7d"
prel[prel$Area%in%c("27_4","27_4_A", "27_4_B", "27_4_C"),"Area"]<-"4"
prel<-prel[prel$Area%in%c("4","3a","7d"),]

prel[prel$Country=="GB","Country"]<-"UK" 
...
# Read in IBTS SMALK data
ibtsq1 <- read.csv("bootstrap/data/SMALK_lemonsole_nsibts_q1.csv")
ibtsq3 <- read.csv("bootstrap/data/SMALK_lemonsole_nsibts_q3.csv")
